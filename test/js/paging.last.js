...
function checkTocList() {
  ...
  assertTreeEqual('+-- toc', tocs[i], 'div', treeNodeToString, [
    '1:body',
    '2:toc-chapter:title link:5.Chapter (5):' +
      './paging.last.xml#idxbkchapter1',
    '3:toc-clause:title link:5.1.Clause (5.1):' +
      './paging.last.xml#idxbkclause1',
    '4:toc-section:title link:5.1.1.Section (5.1.1):' +
      './paging.last.xml#idxbksection1',
    '5:toc-section:title link:5.1.1.1.Section (5.1.1.1):' +
      './paging.last.xml#idxbksection2',
    '5:toc-section:title link:5.1.1.2.Section (5.1.1.2):' +
      './paging.last.xml#idxbksection3',
    '4:toc-section:title link:5.1.2.Section (5.1.2):' +
      './paging.last.xml#idxbksection4',
    '3:toc-clause:title link:5.2.Clause (5.2):' +
      './paging.last.xml#idxbkclause2',
    '4:toc-section:title link:5.2.1.Section (5.2.1):' +
      './paging.last.xml#idxbksection5',
    '4:toc-section:title link:5.2.2.Section (5.2.2):' +
      './paging.last.xml#idxbksection6',
    '2:toc-appendix:title link:C.Appendix (3):' +
      './paging.last.xml#idxbkappendix1',
    '3:toc-clause:title link:C.1.Clause (3.1):' +
      './paging.last.xml#idxbkclause3',
    '4:toc-section:title link:C.1.1.Section (3.1.1):' +
      './paging.last.xml#idxbksection7',
    '4:toc-section:title link:C.1.2.Section (3.1.2):' +
      './paging.last.xml#idxbksection8',
    '3:toc-clause:title link:C.2.Clause (3.2):' +
      './paging.last.xml#idxbkclause4',
    '4:toc-section:title link:C.2.1.Section (3.2.1):' +
      './paging.last.xml#idxbksection9',
    '4:toc-section:title link:C.2.2.Section (3.2.2):' +
      './paging.last.xml#idxbksection10',
    '2:toc-chapter:title link:6.Chpater (6):' +
      './paging.last.xml#idxbkchapter2',
    '2:toc-appendix:title link:D.Appendix (4):' +
  ...
  assertTreeEqual('+-- toc', tocs[i], 'div', treeNodeToString, [
    '1:body',
    '2:toc-clause:title link:5.1.Clause (5.1):' +
      './paging.last.xml#idxbkclause1',
    '3:toc-section:title link:5.1.1.Section (5.1.1):' +
      './paging.last.xml#idxbksection1',
    '4:toc-section:title link:5.1.1.1.Section (5.1.1.1):' +
      './paging.last.xml#idxbksection2',
    '4:toc-section:title link:5.1.1.2.Section (5.1.1.2):' +
      './paging.last.xml#idxbksection3',
    '3:toc-section:title link:5.1.2.Section (5.1.2):' +
      './paging.last.xml#idxbksection4',
    '2:toc-clause:title link:5.2.Clause (5.2):' +
      './paging.last.xml#idxbkclause2',
    '3:toc-section:title link:5.2.1.Section (5.2.1):' +
      './paging.last.xml#idxbksection5',
    '3:toc-section:title link:5.2.2.Section (5.2.2):' +
      './paging.last.xml#idxbksection6',
  ]);
  ...
  assertTreeEqual('+-- toc', tocs[i], 'div', treeNodeToString, [
    '1:body',
    '2:toc-section:title link:5.1.1.Section (5.1.1):' +
      './paging.last.xml#idxbksection1',
    '3:toc-section:title link:5.1.1.1.Section (5.1.1.1):' +
      './paging.last.xml#idxbksection2',
    '3:toc-section:title link:5.1.1.2.Section (5.1.1.2):' +
      './paging.last.xml#idxbksection3',
    '2:toc-section:title link:5.1.2.Section (5.1.2):' +
      './paging.last.xml#idxbksection4',
  ]);
  ...
  assertTreeEqual('+-- toc', tocs[i], 'div', treeNodeToString, [
    '1:body',
    '2:toc-section:title link:5.1.1.1.Section (5.1.1.1):' +
      './paging.last.xml#idxbksection2',
    '2:toc-section:title link:5.1.1.2.Section (5.1.1.2):' +
      './paging.last.xml#idxbksection3',
  ]);
}
