...
function checkTocList() {
  ...
  assertTreeEqual('+-- toc', tocs[0], 'div', treeNodeToString, [
    '1:body',
    '2:toc-section:title link:3.1.1.Section (3.1.1):' +
      './paging.test.xml#idxbksection1',
    '3:toc-section:title link:3.1.1.1.Section (3.1.1.1):' +
      './paging.test.xml#idxbksection2',
    '2:toc-section:title link:3.1.2.Section (3.1.2):' +
      './paging.test.xml#idxbksection3',
    '3:toc-section:title link:3.1.2.1.Section (3.1.2.1):' +
      './paging.test.xml#idxbksection4',
    '3:toc-section:title link:3.1.2.2.Section (3.1.2.2):' +
      './paging.test.xml#idxbksection5',
    '2:toc-section:title link:A.1.1.Section (1.1.1):' +
      './paging.test.xml#idxbksection6',
    '2:toc-section:title link:4.1.1.Clause (4.1.1):' +
      './paging.test.xml#idxbksection7',
    '2:toc-section:title link:B.1.1.Section (2.1.1):' +
