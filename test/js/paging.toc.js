...
function checkNaviLinksInFirstPage(parentTag) {
  ...
  assertEqual('Previous page link\'s class', prevLink.className, 'disabled');
...
function checkTocList() {
  ...
  assertTreeEqual('+-- toc', tocs[0], 'div', treeNodeToString, [
    '1:body',
    '2:toc-preface:title:Preface:' +
      './paging.toc.xml#idxbkpreface1',
    '3:toc-clause:title:Preface (1.1):' +
      './paging.toc.xml#idxbkclause1',
    '2:toc-chapter:title:1.Chapter (1):' +
      './paging.toc.xml#idxbkchapter1',
    '2:toc-chapter:title:2.Chapter (2):' +
      './paging.toc.xml#idxbkchapter2',
    '3:toc-clause:title:2.1.Chapter (2.1):' +
      './paging.toc.xml#idxbkclause2',
    '2:toc-chapter:title:3.Chapter (3):' +
      './paging.test.xml#idxbkchapter1',
    '3:toc-clause:title:3.1.Clause (3.1):' +
      './paging.test.xml#idxbkclause1',
    '2:toc-appendix:title:A.Appendix (1):' +
      './paging.test.xml#idxbkappendix1',
    '3:toc-clause:title:A.1.Clause (1.1):' +
      './paging.test.xml#idxbkclause2',
    '2:toc-chapter:title:4.Chapter (4):' +
      './paging.test.xml#idxbkchapter2',
    '3:toc-clause:title:4.1.Clause (4.1):' +
      './paging.test.xml#idxbkclause3',
    '2:toc-appendix:title:B.Appendix (2):' +
      './paging.test.xml#idxbkappendix2',
    '3:toc-clause:title:B.1.Clause (2.1):' +
      './paging.test.xml#idxbkclause4',
    '2:toc-part:title:Part 1',
    '3:toc-chapter:title:5.Chapter (5):' +
      './paging.last.xml#idxbkchapter1',
    '4:toc-clause:title:5.1.Clause (5.1):' +
      './paging.last.xml#idxbkclause1',
    '4:toc-clause:title:5.2.Clause (5.2):' +
      './paging.last.xml#idxbkclause2',
    '3:toc-appendix:title:C.Appendix (3):' +
      './paging.last.xml#idxbkappendix1',
    '4:toc-clause:title:C.1.Clause (3.1):' +
      './paging.last.xml#idxbkclause3',
    '4:toc-clause:title:C.2.Clause (3.2):' +
      './paging.last.xml#idxbkclause4',
    '3:toc-chapter:title:6.Chpater (6):' +
      './paging.last.xml#idxbkchapter2',
    '3:toc-appendix:title:D.Appendix (4):' +
